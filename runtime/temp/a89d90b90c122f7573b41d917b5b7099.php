<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\public/../application/index\view\auth_group\edit.html";i:1556797563;s:88:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\application\index\view\public\meta.html";i:1554613566;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
	...
	<form class="form form-horizontal" id="form-admin-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $authGroup['title']; ?>" placeholder="请输入角色名称" id="title" name="title">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box" style="width:150px;">
					<select id="status" class="select" name="status" size="1">
						<option value="1" <?php if($authGroup['status'] == 1): ?>selected<?php endif; ?>>启用</option>
						<option value="0" <?php if($authGroup['status'] == 0): ?>selected<?php endif; ?>>禁用</option>
					</select>
				</span>
			</div>
		</div>
					...
					<tr>
						<td>
							<label>
								...
								<input
								<?php $arr=explode(',',$authGroup['rules']); if(in_array($authRule['id'],$arr)){echo "checked";} ?>
								 name="rules[]" value="<?php echo $authRule['id']; ?>" dataid="id-<?php echo $authRule['dataid']; ?>" class="inverted checkbox-parent <?php if($authRule['level'] != 0): ?> checkbox-child <?php endif; ?> " type="checkbox">
				...
				success: function(data){
				    if(data.code == 1) {
						...
						if(data.msg)
						{
							...
							layer.msg('更新角色失败!',{icon:2,time:1000});
						}
					}
				},
