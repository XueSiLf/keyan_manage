<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\public/../application/index\view\hxxmht\lst.html";i:1556361185;s:88:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\application\index\view\public\meta.html";i:1554613566;s:90:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\application\index\view\public\footer.html";i:1553402458;s:86:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\application\index\view\public\js.html";i:1554609812;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="javascript:;" onclick="admin_add('新增合同','<?php echo url('add'); ?>','900','500')" class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i> 新增合同
			</a>
		</span>
		<span class="r">共有合同：<strong><?php echo $count; ?></strong> 项</span>
	</div>

	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="9">合同列表</th>
			</tr>
			<tr class="text-c">
		...
		<tbody>
		<?php if(is_array($hxxmht) || $hxxmht instanceof \think\Collection || $hxxmht instanceof \think\Paginator): $i = 0; $__LIST__ = $hxxmht;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<tr class="text-c">
			<td><?php echo $vo['ht_id']; ?></td>
			<td><?php echo $vo['ht_name']; ?></td>
			<td><?php echo $vo['ht_leader']; ?></td>
			<td><?php echo $vo['ht_type']; ?></td>
			<td>
				<?php echo $vo['jh_type']; ?>
			</td>
			<td><?php echo date('Y-m-d',$vo['ht_sxdate']); ?></td>
			...
			<td class="td-manage" width="200">
				...
				<!-- <a title="下载" target='_blank' class="size-S btn btn-secondary radius"  style="text-decoration:none" download='' href='/uploads/<?php echo $vo['filepath']; ?>'>
					下载
				</a> -->
