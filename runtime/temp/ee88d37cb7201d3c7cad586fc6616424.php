<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:99:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\public/../application/index\view\zlcg\zlcglst.html";i:1556984668;s:88:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\application\index\view\public\meta.html";i:1554613566;s:90:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\application\index\view\public\footer.html";i:1553402458;s:86:"D:\software\ITtools\myphp_www\PHPTutorial\WWW\ky\application\index\view\public\js.html";i:1554609812;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="javascript:;" onclick="admin_add('新增专利成果','<?php echo url('add'); ?>','900','500')" class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i> 新增专利成果
			</a>
		</span>
		<span class="r">共有专利成果：<strong><?php echo $count; ?></strong> 项</span>
	</div>

	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="10">专利成果列表</th>
			</tr>
			<tr class="text-c">
		...
		<tbody>
		<?php if(is_array($zlcg) || $zlcg instanceof \think\Collection || $zlcg instanceof \think\Paginator): $i = 0; $__LIST__ = $zlcg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<tr class="text-c">
			<td><?php echo $vo['id']; ?></td>
			<td><?php echo $vo['zl_name']; ?></td>
			<td><?php echo $vo['zl_ownerbmid']; ?></td>
			<td><?php echo $vo['zl_owner']; ?></td>
			<td><?php echo $vo['zl_type']; ?></td>
			<td>
				<?php echo $vo['zl_status']; ?>
			</td>
			<td><?php echo date('Y-m-d',$vo['zl_apply_time']); ?></td>
			<td><?php echo $vo['zl_apply_num']; ?></td>
			<td><?php echo $vo['zl_inventor']; ?></td>
			<td class="td-manage" width="200">
				...
				<?php if($vo['zl_status'] == ('待学院审核' or '待学校审核')): ?>
